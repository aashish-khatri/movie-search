...
import Poster from "../images/poster-alt.jpg";
const Card = (props) => {
	const { data } = props;
	...
	return (
		<div className="container pv3-ns bt-ns b--grey white-90 w-70 mw7-ns center mt3 mb5 mv4-ns ">
			<div className="poster-container mv2 fl-ns w-40-ns">
				<img className="poster" alt={Poster} src={posterPath} />
			</div>
			<div className="content pl4-ns fl-ns w-60-ns f6 measure">
				...
				<div className="extra-content mt4">
					...
					<div className="other-details light-blue f5 mt4">
						<div className="fl w-50 ">
							Original Release:
							<span className="f3 db white-80">
								{data.release ? data.release : "N/A"}
							</span>
						</div>
						<div className=" fl w-50">
							Running Time:
